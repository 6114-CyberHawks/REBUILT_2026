...
import frc.robot.commands.GetDistanceToTarget;
...
public class RobotContainer {
  ...
  private final GetDistanceToTarget getDistanceToTarget;
  ...
  public RobotContainer() {
    ...
    rotateToTarget = new RotateToTarget(driveSubsystem);
    rotateToTarget.addRequirements(driveSubsystem);

    getDistanceToTarget = new GetDistanceToTarget(driveSubsystem);
    getDistanceToTarget.addRequirements(driveSubsystem);
  ...
  private void configureBindings() {
    ...
    new JoystickButton(m_driverController, XboxController.Button.kX.value)
        .whileTrue(new GetDistanceToTarget(driveSubsystem));
